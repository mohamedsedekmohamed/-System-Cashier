    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">أدخل بيانات الفرع الجديد وحدد موقعه على الخريطة</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} noValidate>
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-900/30">
            <h2 className="font-bold text-slate-700 dark:text-slate-200 text-sm">بيانات الفرع الأساسية والموقع</h2>
          </div>
          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            {/* Address */}
            <div className="md:col-span-2">
              <Field id="address" label="العنوان التفصيلي" required error={errors.address}>
                <textarea id="address" name="address" rows={2} value={form.address} onChange={handleChange}
                  placeholder="العنوان التفصيلي للفرع (المدينة، الحي، الشارع)" disabled={isPending} className={`${inputClass(!!errors.address)} resize-none`} />
              </Field>
            </div>
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1.5">
                تحديد موقع الفرع على الخريطة (Location) <span className="text-red-400">*</span>
              </label>
              <p className="text-xs text-slate-400 mb-3">اضغط على الخريطة لوضع علامة الفرع، أو اسحب العلامة، أو استخدم البحث وزر "موقعي الحالي"</p>
            ...
            {/* WhatsApp */}
            <Field id="watts" label="رقم الواتساب" required error={errors.watts} hint="أرقام فقط (مثال: 966501234567)">
              <input 
                id="watts" 
                name="watts" 
                type="tel"
