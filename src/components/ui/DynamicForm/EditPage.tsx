...
export interface EditPageProps {
  ...
  fields: FormFieldDef[];
  /** Initial form values (from fetched data) */
...
const EditPage: React.FC<EditPageProps> = ({
  ...
  // Sync form data when initialValues change (data fetched)
  useEffect(() => {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              {icon ? <span className="text-primary">{icon}</span> : <MdEdit size={24} className="text-primary" />}
